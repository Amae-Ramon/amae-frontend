  ...
  return (
    <main className="relative min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        <Image
          src="/pillar-1.jpg"
          alt="Sleep - A woman peacefully sleeping"
          fill
          priority
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 sm:px-8 text-center">
          <h2 className="font-serif text-3xl sm:text-4xl md:text-5xl text-maroon leading-tight mb-6 md:mb-8">
            Gentle, expert guidance that
            <br />
            helps moms find rest again.
          </h2>

          <p className="font-sans text-sm sm:text-base text-maroon/80 leading-relaxed">
            From newborn sleep patterns to long-term routines, support is
            <br className="hidden sm:block" />
            tailored to each household.
          </p>
        </div>
      </section>

      {/* Services Provided (STACKED + TEXT ON IMAGE + TALL CARDS) */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          {(() => {
            const services = [
              {
                price: "£300",
                title: "The Baby Experience: New parents home visit",
                desc: "The baby experience is founded by Lou Toseby (NCT Breastfeeding Counsellor, Holistic Sleep Coach…).",
                img: "/pillar-1.jpg",
              },
              {
                price: "£275",
                title: "Remote consultation by video",
                desc: "The baby experience is founded by Lou Toseby (NCT Breastfeeding Counsellor, Holistic Sleep Coach…).",
                img: "/pillar-1.jpg",
              },
              {
                price: "£385",
                title: "Home consultation + follow-up support",
                desc: "The baby experience is founded by Lou Toseby (NCT Breastfeeding Counsellor, Holistic Sleep Coach…).",
                img: "/pillar-1.jpg",
              },
              {
                price: "£270",
                title: "The Mindful Sleep Coach: Early years bundle",
                desc: "The Mindful Sleep Coach supports families to feel confident and empowered in making positive sleep changes…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£385",
              ...
              {
                price: "£45",
                title: "Stellar Sleep School: Stella Sleep SOS call",
                desc: "Daily with has supported families with infant and child sleep since 2018. In 2025, she founded…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£95",
                title: "The Stellar Newborn & Early Sleep Course",
                desc: "Daily with has supported families with infant and child sleep since 2018. In 2025, she founded…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£250",
                title: "The Stellar Infant & Child Sleep Support Programme",
                desc: "Daily with has supported families with infant and child sleep since 2018. In 2025, she founded…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£225",
                title: "Night Nannies for 1 night",
                desc: "Night Nannies has been running since 1999, founded by former TV journalist, Anastasia Baker…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£275",
                title: "Twins: a night to the nanny",
                desc: "Night Nannies has been running since 1999, founded by former TV journalist, Anastasia Baker…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£315",
                title: "Triplets: a night to the nanny",
                desc: "Daily with has supported families with infant and child sleep since 2018. In 2025, she founded…",
                img: "/pillar-1.jpg",
              },
              {
                price: "£63",
                title: "Peace and Riot 1 night babysitting (3hrs • 1–2 children)",
                desc: "Short evening babysitting support to give parents breathing room and a proper reset.",
                img: "/pillar-1.jpg",
              },
            ];
                ...
                {services.map((s, idx) => (
                  ...
                  >
                    <div className="relative h-[520px] sm:h-[560px] md:h-[600px]">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-black/10 to-[#f3e1c9]/70" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="font-sans text-sm text-maroon/70 leading-relaxed max-w-xs">
                We partner with only trusted specialists, ensuring safe and
                reliable care for new mothers.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="font-sans text-sm text-maroon/70 leading-relaxed max-w-xs">
                Offer support that truly matters. Amae gifts are flexible,
                thoughtful and designed to ease, not add to, new moms&apos; lives.
              </p>
            </div>
